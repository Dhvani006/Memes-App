...
import 'package:memesapp/controller/fatchMeme.dart';
import 'package:memesapp/controller/saveMyData.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("Dhvani Kotak",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
